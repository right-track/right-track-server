define({ "api": [
  ...
  },
  {
    ...
    "name": "submitFeedback",
    "group": "Feedback",
    "description": "<p>Submit feedback that will be sent to the configured contact address by the API Server via email.</p>",
    "permission": [
      {
        "name": "feedback"
      }
        ...
        "Query Arguments": [
          {
            ...
            "optional": true,
            "field": "download",
            "description": "<p>When set to <code>true</code> or <code>latest</code>, download the agency database file</p>"
          }
        ]
      }
    },
