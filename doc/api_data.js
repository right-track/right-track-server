define({ "api": [
  ...
  },
  {
    ...
    "name": "cleanServer",
    "group": "Admin",
    "description": "<p>Remove expired sessions and tokens from the API Server MySQL Database</p>",
    "permission": [
      {
        "name": "admin",
  ...
  },
  {
    ...
    "name": "getMetrics",
    "group": "Admin",
    "description": "<p>Get some of the server stats displayed as Prometheus metrics.</p>",
    "permission": [
      {
        "name": "admin",
        "title": "API-Access: admin",
  ...
  },
  {
    ...
    "group": "Auth",
    "description": "<p>Request a password reset token be sent to the specified User</p>",
    "permission": [
      {
        "name": "auth",
        ...
        "Query Arguments": [
          {
            ...
            "optional": false,
            "field": "user",
            "description": "<p>The User's email address or username</p>"
          },
          {
            "group": "Query",
            "type": "string",
            "optional": false,
            "field": "url",
            "description": "<p>The API Client's password reset page URL.  This URL will allow the User to confirm the password reset token and create a new password. An email with this URL will be sent to the User's registered email address.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "group": "Auth",
    "description": "<p>Reset a User's password with a password reset token</p>",
    "permission": [
      {
        "name": "auth",
        "title": "API-Access: auth",
      ...
      "fields": {
        ...
        "Body Parameters": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "password",
            "description": "<p>User password properties</p>"
          },
          {
            "group": "Body",
            "type": "string",
  ...
  {
    "type": "GET",
    "url": "/maps/center/:agency",
    "title": "Get Center of All Shapes",
    "name": "getCenter",
    "group": "Maps",
    "description": "<p>Get the center coordinates of all of the Shapes from the specified agency.</p>",
    "permission": [
      {
        "name": "gtfs",
    ...
    "version": "0.0.0",
    "filename": "src/routes/maps/routes.js",
    "groupTitle": "Maps"
  },
  {
    "type": "GET",
    "url": "/maps/shapes/:agency/:id",
    "title": "Get Shape",
    "name": "getShape",
    "group": "Maps",
    "description": "<p>Get the GTFS Shape Points for the specified Shape.  The response is formatted as a GeoJSON LineString feature.</p>",
    "permission": [
      {
        "name": "gtfs",
        "title": "API-Access: gtfs",
      ...
      "fields": {
        ...
        "404 Error Codes": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "4042",
            "description": "<p>Shape Not Found</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "GET",
    "url": "/maps/center/:agency/:id",
    "title": "Get Center of Shape",
    "name": "getShapeCenter",
    "group": "Maps",
    "description": "<p>Get the center coordinates of the specified Shape.</p>",
    "permission": [
      {
        "name": "gtfs",
        "title": "API-Access: gtfs",
  ...
  {
    "type": "GET",
    "url": "/maps/shapes/:agency",
    "title": "Get All Shapes",
    "name": "getShapes",
    "group": "Maps",
    "description": "<p>Get all of the GTFS Shape Points for the specified agency.  The response is formatted as a GeoJSON Feature Collection of LineStrings.</p>",
    "permission": [
      {
        "name": "gtfs",
        "title": "API-Access: gtfs",
      ...
      "fields": {
        ...
        "404 Error Codes": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "4042",
            "description": "<p>The Agency does not have any Shapes</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "GET",
    "url": "/maps/stops/:agency/:id",
    "title": "Get Stop",
    "name": "getStopGeo",
    "group": "Maps",
    "description": "<p>Get the specified Stop from the specified Agency.  The response is formatted as a GeoJSON Point feature.</p>",
    "permission": [
      {
        "name": "gtfs",
        "title": "API-Access: gtfs",
  ...
  {
    "type": "GET",
    "url": "/maps/stops/:agency",
    "title": "Get All Stops",
    "name": "getStopsGeo",
    "group": "Maps",
    "description": "<p>Get all of the Stops for the specified agency.  The response is formatted as a GeoJSON Feature Collection of Points.</p>",
    "permission": [
      {
        "name": "gtfs",
        "title": "API-Access: gtfs",
      ...
      "fields": {
        ...
        "404 Error Codes": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "4042",
            "description": "<p>Stops Not Found</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "GET",
    "url": "/transit/:transitAgency/:transitDivision(s)/icon",
      ...
      "fields": {
        "Path Parameters": [
          ...
          },
          {
            ...
            "description": "<p>(s) RT Transit Division Code(s)</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "GET",
    "url": "/updates/apps/:host",
    "title": "Published App Version",
    "name": "appVersion",
    "group": "Updates_Apps",
    "description": "<p>Get the published version info of the specified app</p>",
    "permission": [
      {
        "name": "updates",
        ...
        "404 Error Codes": [
          {
            ...
            "optional": false,
            "field": "4045",
            "description": "<p>Unknown App Host</p>"
          }
        ]
      }
    },
    ...
    "version": "0.0.0",
    "filename": "src/routes/updates/apps/routes.js",
    "groupTitle": "Updates_Apps"
  },
  {
    "type": "GET",
  ...
  },
  {
    ...
    "group": "Users",
    "description": "<p>Request an email verification Token for the specified User.</p>",
    "permission": [
      {
        "name": "registration",
        "title": "API-Access: registration",
        ...
        "Query Arguments": [
          {
            ...
            "optional": false,
            "field": "url",
            "description": "<p>The API Client's confirmation page URL.  This URL will allow the User to confirm the verification token.  An email with this URL will be sent to the User's registered email address.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "PUT",
    "url": "/users/:userID/verify",
    "title": "Verify Email Verification Token",
    "name": "verifyEmailVerificationToken",
    "group": "Users",
    "description": "<p>Verify the email verification Token for the specified User.</p>",
    "permission": [
      {
        "name": "registration",
        "title": "API-Access: registration",
        ...
        "Body Parameters": [
          {
            ...
            "optional": false,
            "field": "token",
            "description": "<p>The Token to verify as a valid email verification token</p>"
          }
        ]
      }
    },
